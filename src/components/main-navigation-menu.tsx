    ...
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul id="myNav" className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                ...
                >
                  ...
                  <div className="mb-2 mt-3 text-lg font-medium">Livedata</div>
                  <p className="text-sm leading-tight text-muted-foreground">
                  Esperienza utente al centro della nostra codifica.
                  </p>
                </a>
              </li>
